...
pub(crate) const AFRICA_MAPUTO: TimeZoneRef<'static> = new_time_zone_ref(
    &[new_transition(-1924999818, 1)],
    &[
        new_local_time_type(7818, false, Some(b"LMT")),
        new_local_time_type(7200, false, Some(b"CAT")),
    ],
    &[],
    &Some(TransitionRule::Fixed(new_local_time_type(
...
pub(crate) const AMERICA_ASUNCION: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(1364094000, 2),
        new_transition(1381032000, 4),
        new_transition(1395543600, 2),
        new_transition(1412481600, 4),
        new_transition(1426993200, 2),
        new_transition(1443931200, 4),
        new_transition(1459047600, 2),
        new_transition(1475380800, 4),
        new_transition(1490497200, 2),
        new_transition(1506830400, 4),
        new_transition(1521946800, 2),
        new_transition(1538884800, 4),
        new_transition(1553396400, 2),
        new_transition(1570334400, 4),
        new_transition(1584846000, 2),
        new_transition(1601784000, 4),
        new_transition(1616900400, 2),
        new_transition(1633233600, 4),
        new_transition(1648350000, 2),
        new_transition(1664683200, 4),
        new_transition(1679799600, 2),
        new_transition(1696132800, 4),
        new_transition(1711249200, 2),
        new_transition(1728187200, 4),
        new_transition(1728961200, 3),
    ],
    &[
...
pub(crate) const AMERICA_BAHIA_BANDERAS: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(-1343149200, 2),
        new_transition(-1234807200, 1),
        new_transition(-1220461200, 3),
...
pub(crate) const AMERICA_CANCUN: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(378201600, 2),
        new_transition(410504400, 1),
...
pub(crate) const AMERICA_COYHAIQUE: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        new_transition(-2524504304, 1),
        ...
        new_transition(1693713600, 5),
        new_transition(1712458800, 3),
        new_transition(1725768000, 5),
        new_transition(1742439600, 6),
    ],
    &[
        new_local_time_type(-17296, false, Some(b"LMT")),
...
pub(crate) const AMERICA_EDMONTON: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(1289116800, 2),
        new_transition(1300006800, 1),
        new_transition(1320566400, 2),
        new_transition(1331456400, 1),
        new_transition(1352016000, 2),
        new_transition(1362906000, 1),
        new_transition(1383465600, 2),
        new_transition(1394355600, 1),
        new_transition(1414915200, 2),
        new_transition(1425805200, 1),
        new_transition(1446364800, 2),
        new_transition(1457859600, 1),
        new_transition(1478419200, 2),
        new_transition(1489309200, 1),
        new_transition(1509868800, 2),
        new_transition(1520758800, 1),
        new_transition(1541318400, 2),
        new_transition(1552208400, 1),
        new_transition(1572768000, 2),
        new_transition(1583658000, 1),
        new_transition(1604217600, 2),
        new_transition(1615712400, 1),
        new_transition(1636272000, 2),
        new_transition(1647162000, 1),
        new_transition(1667721600, 2),
        new_transition(1678611600, 1),
        new_transition(1699171200, 2),
        new_transition(1710061200, 1),
        new_transition(1730620800, 2),
        new_transition(1741510800, 1),
        new_transition(1762070400, 2),
        new_transition(1772960400, 1),
        new_transition(1793520000, 5),
    ],
    &[
...
pub(crate) const AMERICA_ENSENADA: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(-292431600, 2),
        new_transition(-273682800, 3),
        new_transition(-260982000, 2),
        new_transition(-242233200, 3),
        new_transition(-226508400, 2),
        new_transition(-210783600, 3),
        new_transition(-195058800, 2),
        new_transition(-179334000, 3),
        new_transition(-163609200, 2),
        new_transition(-147884400, 3),
        new_transition(-131554800, 2),
        new_transition(-116434800, 3),
        new_transition(-100105200, 2),
        new_transition(-84376800, 3),
        new_transition(-68655600, 2),
        new_transition(-52927200, 3),
        new_transition(-37206000, 2),
        new_transition(-21477600, 3),
        new_transition(-5756400, 2),
        new_transition(9972000, 3),
        new_transition(25693200, 2),
        new_transition(41421600, 3),
        new_transition(57747600, 2),
        new_transition(73476000, 3),
        new_transition(89197200, 2),
        new_transition(104925600, 3),
        new_transition(120646800, 2),
        new_transition(126698400, 3),
        new_transition(152096400, 2),
        new_transition(162381600, 3),
...
pub(crate) const AMERICA_INUVIK: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(1162108800, 3),
        new_transition(1173603600, 4),
        new_transition(1194163200, 3),
        new_transition(1205053200, 4),
        new_transition(1225612800, 3),
        new_transition(1236502800, 4),
        new_transition(1257062400, 3),
        new_transition(1268557200, 4),
        new_transition(1289116800, 3),
        new_transition(1300006800, 4),
        new_transition(1320566400, 3),
        new_transition(1331456400, 4),
        new_transition(1352016000, 3),
        new_transition(1362906000, 4),
        new_transition(1383465600, 3),
        new_transition(1394355600, 4),
        new_transition(1414915200, 3),
        new_transition(1425805200, 4),
        new_transition(1446364800, 3),
        new_transition(1457859600, 4),
        new_transition(1478419200, 3),
        new_transition(1489309200, 4),
        new_transition(1509868800, 3),
        new_transition(1520758800, 4),
        new_transition(1541318400, 3),
        new_transition(1552208400, 4),
        new_transition(1572768000, 3),
        new_transition(1583658000, 4),
        new_transition(1604217600, 3),
        new_transition(1615712400, 4),
        new_transition(1636272000, 3),
        new_transition(1647162000, 4),
        new_transition(1667721600, 3),
        new_transition(1678611600, 4),
        new_transition(1699171200, 3),
        new_transition(1710061200, 4),
        new_transition(1730620800, 3),
        new_transition(1741510800, 4),
        new_transition(1762070400, 3),
        new_transition(1772960400, 4),
        new_transition(1793520000, 5),
    ],
    &[
        new_local_time_type(0, false, Some(b"-00")),
...
pub(crate) const AMERICA_VANCOUVER: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(1394359200, 1),
        new_transition(1414918800, 2),
        new_transition(1425808800, 1),
        new_transition(1446368400, 2),
        new_transition(1457863200, 1),
        new_transition(1478422800, 2),
        new_transition(1489312800, 1),
        new_transition(1509872400, 2),
        new_transition(1520762400, 1),
        new_transition(1541322000, 2),
        new_transition(1552212000, 1),
        new_transition(1572771600, 2),
        new_transition(1583661600, 1),
        new_transition(1604221200, 2),
        new_transition(1615716000, 1),
        new_transition(1636275600, 2),
        new_transition(1647165600, 1),
        new_transition(1667725200, 2),
        new_transition(1678615200, 1),
        new_transition(1699174800, 2),
        new_transition(1710064800, 1),
        new_transition(1730624400, 2),
        new_transition(1741514400, 1),
        new_transition(1762074000, 2),
        new_transition(1772964000, 1),
        new_transition(1793523600, 5),
    ],
    &[
...
pub(crate) const ASIA_MANILA: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        new_transition(-3944621032, 1),
        new_transition(-2219083200, 3),
        new_transition(-1046678400, 2),
        new_transition(-1040115600, 3),
        new_transition(-885024000, 2),
        new_transition(-880016400, 4),
        new_transition(-783594000, 2),
        new_transition(-760093200, 3),
        new_transition(-496224000, 2),
        new_transition(-491562000, 3),
        new_transition(228326400, 2),
        new_transition(243702000, 3),
        new_transition(643219200, 2),
        new_transition(649177200, 3),
    ],
    &[
        new_local_time_type(-57368, false, Some(b"LMT")),
        new_local_time_type(29032, false, Some(b"LMT")),
...
pub(crate) const ATLANTIC_AZORES: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(-1667426400, 2),
        new_transition(-1647730800, 3),
        new_transition(-1635890400, 2),
        new_transition(-1616194800, 3),
        new_transition(-1604354400, 2),
        new_transition(-1584658800, 3),
        new_transition(-1572732000, 2),
        new_transition(-1553036400, 3),
        new_transition(-1541196000, 2),
        new_transition(-1521500400, 3),
        new_transition(-1442444400, 2),
        new_transition(-1427670000, 3),
        ...
        new_transition(-118267200, 2),
        new_transition(-102542400, 5),
        new_transition(386125200, 4),
        ...
        new_transition(725421600, 7),
        new_transition(733280400, 6),
        new_transition(740278800, 4),
...
pub(crate) const ATLANTIC_MADEIRA: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(-118270800, 2),
        new_transition(-102546000, 5),
        new_transition(386726400, 6),
        new_transition(401846400, 5),
        new_transition(417571200, 6),
        new_transition(433296000, 5),
        new_transition(449020800, 6),
        new_transition(465350400, 5),
        new_transition(481075200, 6),
        new_transition(496800000, 5),
        new_transition(512524800, 6),
        new_transition(528253200, 5),
...
pub(crate) const EUROPE_CHISINAU: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(1301184000, 3),
        new_transition(1319932800, 4),
        new_transition(1332633600, 3),
        new_transition(1351382400, 4),
        new_transition(1364688000, 3),
        new_transition(1382832000, 4),
        new_transition(1396137600, 3),
        new_transition(1414281600, 4),
        new_transition(1427587200, 3),
        new_transition(1445731200, 4),
        new_transition(1459036800, 3),
        new_transition(1477785600, 4),
        new_transition(1490486400, 3),
        new_transition(1509235200, 4),
        new_transition(1521936000, 3),
        new_transition(1540684800, 4),
        new_transition(1553990400, 3),
        new_transition(1572134400, 4),
        new_transition(1585440000, 3),
        new_transition(1603584000, 4),
        new_transition(1616889600, 3),
        new_transition(1635638400, 4),
        new_transition(1640988000, 4),
    ],
    &[
...
pub(crate) const IRAN: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(279576000, 3),
        new_transition(296512200, 2),
...
pub(crate) const PORTUGAL: TimeZoneRef<'static> = new_time_zone_ref(
    &[
        ...
        new_transition(-1667433600, 1),
        new_transition(-1647738000, 2),
        new_transition(-1635897600, 1),
        new_transition(-1616202000, 2),
        new_transition(-1604361600, 1),
        new_transition(-1584666000, 2),
        new_transition(-1572739200, 1),
        new_transition(-1553043600, 2),
        new_transition(-1541203200, 1),
        ...
        new_transition(323830800, 1),
        new_transition(338950800, 2),
        new_transition(354672000, 1),
        new_transition(370396800, 2),
        new_transition(386121600, 1),
        new_transition(401846400, 2),
        new_transition(417571200, 1),
        new_transition(433296000, 2),
        new_transition(449020800, 1),
        new_transition(465350400, 2),
        new_transition(481075200, 1),
        new_transition(496800000, 2),
        new_transition(512528400, 1),
        new_transition(528253200, 2),
        new_transition(543978000, 1),
